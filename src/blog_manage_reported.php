                ...
                <div class="navbar-default sidebar">
                    <div class="sidebar-nav">
                        <ul class="nav">
                            ...
                            <li class="active"><a href="blog_manage_reported.php"><i class="glyphicon glyphicon-open"></i> 已发布</a></li>
                        ...
                        <div class="list-item">
                            <div class="item-title">
                                ...
                                <div class="item-bottom  col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <a href="#" class="item-btn btn btn-xs btn-warning pull-right">撤回</a>
