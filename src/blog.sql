...
CREATE TABLE `chat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chat_create_user_id` int(11) NOT NULL,
  `chat_target_user_id` int(11) NOT NULL,
  `chat_content` varchar(255) NOT NULL,
  `chat_create_time` datetime NOT NULL,
  `chat_delete_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_chat_user_1` (`chat_create_user_id`),
  KEY `fk_chat_user_2` (`chat_target_user_id`),
  CONSTRAINT `fk_chat_user_1` FOREIGN KEY (`chat_create_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_chat_user_2` FOREIGN KEY (`chat_target_user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `like` (
  ...
  `like_target_blog_id` int(11) DEFAULT NULL,
  `like_create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `like_create_user_id` (`like_create_user_id`),
  KEY `like_target_user_id` (`like_target_blog_id`)
...
CREATE TABLE `user` (
  ...
  `user_is_admin` smallint(1) DEFAULT '0',
